<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsertarGastoVista.aspx.cs" Inherits="EstiloyColorERP.publico.RegistrarGastoView" %>
    ...
    <br />
        <section id="formulario">
            ...
            <div id="divi">
                ...
                <asp:TextBox ID="tbConcepto" type="text" CssClass="form-control1" runat="server" required=""></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lblTotal" CssClass="col-sm-2 control-label" runat="server" Text="Total"></asp:Label>
                <asp:TextBox ID="tbTotal" type="number" CssClass="form-control1"  runat="server" required=""></asp:TextBox>
                <br />
                <br />
