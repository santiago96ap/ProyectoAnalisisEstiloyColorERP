<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ObtenerClienteVista.aspx.cs" Inherits="EstiloyColorERP.ObtenerCliente" %>
        ...
        <ContentTemplate>
            <section id="formulario1">
                ...
                <div id="divi10">
                    ...
                    <br />
                    <br />
                    <asp:GridView ID="gvClientes" CssClass="table table-hover" runat="server" RowHeaderColumn="Clientes"></asp:GridView>
                    <br />
